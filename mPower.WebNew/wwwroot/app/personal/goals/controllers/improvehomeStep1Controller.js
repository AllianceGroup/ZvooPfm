...
angular.module('app.personal').controller('ImprovehomeStep1Controller',
['estimateService', 'model', '$state', function (estimateService, model, $state) {
    ...
    ctrl.estimate = function() {
        ...
        estimateService.estimateImprovehome(ctrl.model).then(function(model) {
    ...
    ctrl.step2 = function () {
        ctrl.errors = [];
        estimateService.finishImprovehome(ctrl.model).then(function (goal) {

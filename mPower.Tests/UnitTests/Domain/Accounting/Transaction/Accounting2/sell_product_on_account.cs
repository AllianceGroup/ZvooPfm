...
{
    public class sell_product_on_account : TransactionTest
    {
        public override IEnumerable<Paralect.Domain.IEvent> Given()
        {
            ...
            yield return Ledger_Account_Added("Liability account", AccountTypeEnum.Liability, AccountLabelEnum.OtherCurrentAsset);
            ...
            yield return Transaction_Created("2")
               .AddEntry("Accounts receivable", 800, 0, CurrentDate, AccountTypeEnum.Asset, AccountLabelEnum.AccountsReceivable, "Liability account", "Liability account")
               .AddEntry("Liability account", 0, 800, CurrentDate, AccountTypeEnum.Liability, AccountLabelEnum.OtherCurrentLiability, "Accounts receivable", "Accounts receivable");

            yield return Ledger_Account_BalanceChanged("Accounts receivable", 800);
            yield return Ledger_Account_BalanceChanged("Liability account", 1000 + 800);
        }

        public override IEnumerable<Paralect.Domain.ICommand> When()
        {
            yield return Transaction_Create("sell_product_on_account")
             .AddEntry("Product sales", 0, 100, CurrentDate, AccountTypeEnum.Income, AccountLabelEnum.Income, "Accounts receivable", "Accounts receivable")
             .AddEntry("Accounts receivable", 100, 0, CurrentDate, AccountTypeEnum.Asset, AccountLabelEnum.AccountsReceivable, "Product sales", "Product sales");
        }

        public override IEnumerable<Paralect.Domain.IEvent> Expected()
        {
            yield return Transaction_Created("sell_product_on_account")
             .AddEntry("Product sales", 0, 100, CurrentDate, AccountTypeEnum.Income, AccountLabelEnum.Income, "Accounts receivable", "Accounts receivable")
             .AddEntry("Accounts receivable", 100, 0, CurrentDate, AccountTypeEnum.Asset, AccountLabelEnum.AccountsReceivable, "Product sales", "Product sales");
        }
        ...
        public void Test()
        {
            ...
            DispatchEvents(() =>
            {
                CheckBalance(
                    ...
                    new KeyValuePair<string, long>("Accounts receivable", 900));
                ...
                var transactionDoc = _transactionDocumentService.GetById("sell_product_on_account");
                ...
                Assert.AreEqual(900, account2.Denormalized.Balance);
                ...
                //var mobileEntries = _mobileEntryDocumentService.GetByFilter(new MobileEntryFilter {TransactionId = "sell_product_on_account"});
                ...
                //Assert.AreEqual(AccountingFormatter.CentsToDollarString(0, 100, AccountTypeEnum.Income), mobileEntry1.AmountInDollars);
                //Assert.AreEqual(AccountingFormatter.CentsToDollarString(100, 0, AccountTypeEnum.Asset), mobileEntry2.AmountInDollars);
                ...
                //Assert.AreEqual(900, mobileAccount2.Balance);
            });
        }
    }
}

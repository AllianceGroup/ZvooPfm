...
{
    public class statistic_transaction_creation_test : TransactionTest
    {
        ...
        public void Test()
        {
            DispatchEvents(() =>
            {
                ...
                Assert.AreEqual(100, assets[0].DebitAmountInCents);
                Assert.AreEqual(50, assets[0].CreditAmountInCents);
                ...
                Assert.AreEqual(50, liabilities[0].CreditAmountInCents);
            });
        }
    }
}
